function [strain,rtrain,stest,rtest] = cvfold(stim,resp,k,testfold,varargin)
%CVFOLD  Partition data into folds for cross-validation.
%   [STRAIN,RTRAIN] = CVFOLD(STIM,RESP,K) partitions the stimulus and
...
%
%   [STRAIN,RTRAIN,STEST,RTEST] = CVFOLD(STIM,RESP,K,TESTFOLD) returns
...
%   default.
%
%   [...] = CVFOLD(...,'PARAM1',VAL1,'PARAM2',VAL2,...) specifies
